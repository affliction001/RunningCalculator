...
function writeDayWeek(dayKm, weekKm, dayDate) {
	...
	switch (new Date(dayDate).getDay()) {
		case 0: str = "Пн ----- " + week1 + " км.";
				weekValue = week1;
				break;
		case 1: str = "Вт ----- " + week2 + " км.";
				weekValue = week2;
				break;
		case 2: str = "Ср ----- " + week3 + " км.";
				weekValue = week3;
				break;
		case 3: str = "Чт ----- " + week4 + " км.";
				weekValue = week4;
				break;
		case 4: str = "Пт ----- " + week5 + " км.";
				weekValue = week5;
				break;
		case 5: str = "Сб ----- " + week6 + " км.";
				weekValue = week6;
				break;
		case 6: str = "Вс ----- " + week7 + " км.";
				weekValue = week7;
				break;
	}
